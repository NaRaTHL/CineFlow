        ...
        <div class="group relative">
          <div class="relative overflow-hidden rounded-lg shadow-lg">
            ...
            <div class="absolute top-2 right-2 flex flex-col gap-1">
              <button class="watchlist-btn p-1.5 rounded-md ${inWatchlist ? 'bg-red-600' : 'bg-gray-800 hover:bg-red-600'}" 
                data-id="${item.id}" title="Watchlist">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4" viewBox="0 0 24 24">
                  <path d="M5 3a2 2 0 0 0-2 2v16l9-4 9 4V5a2 2 0 0 0-2-2H5z"/>
                </svg>
              </button>

              <button class="watched-btn p-1.5 rounded-md ${inWatched ? 'bg-green-600' : 'bg-gray-800 hover:bg-green-600'}" 
                data-id="${item.id}" title="${inWatched ? 'Viewed' : 'Mark as Watched'}">
                ${inWatched 
                  ...
                  : `<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" 
                      ...
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        d="M2.458 12C3.732 7.943 7.523 5 12 5s8.268 2.943 9.542 7c-1.274 4.057-5.065 
